...
public class PS3EyeFrameGrabber extends FrameGrabber {
     ...
     */
     public IplImage grab_RGB4() {
        ...
        while (!camera.getCameraFrame(ps3_frame, timeout)) {
...
//                cvCvtColor(img, image_1ch, ImgProc.COLOR_RGB2GRAY);
//                img = image_1ch;
//        }
        return img;
    }
    ...
    public void start() throws Exception {
        ...
        if (ps3_frame == null) {
            ...
            image_4ch = IplImage.create(imageWidth, imageHeight, opencv_core.IPL_DEPTH_8U, 4);
            image_1ch = IplImage.create(imageWidth, imageHeight, opencv_core.IPL_DEPTH_8U, 1);
        }
...
//					int[] img = frameGrabber.grab_raw();
//					Mat matImg = new Mat(640, 480, CvType.CV_8UC1);
//					matImg.put(0, 0, img);
//					BufferedImage buffImg = PS3EyeFrameGrabber.toBufferedImage(matImg);
